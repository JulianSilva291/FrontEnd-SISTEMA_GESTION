        ...
        <Card variant="outlined" sx={{ mt: 2, border: 'none', boxShadow: 'none' }}>
            <CardContent>
                ...
                <Grid container spacing={3}>
                    ...
                    {/* === PADRE === */}
                    <Grid size={{ xs: 12 }}><Typography variant="subtitle2" color="primary">Información del Padre</Typography></Grid>
                    ...
                    {/* === MADRE === */}
                    <Grid size={{ xs: 12 }} sx={{ mt: 1 }}><Typography variant="subtitle2" color="primary">Información de la Madre</Typography></Grid>
